...
num_clients = 3
num_classes = 4
dir_path = "/Users/jay/Desktop/paper/code/fl/dataset/bal/"
...
def generate_tumor_2(dir_path, num_clients, num_classes, niid, balance, partition):
    ...
    train_data = torchvision.datasets.ImageFolder(root='/Users/jay/datasets/Brain_Tumor_2/train', transform=transform)
    test_data = torchvision.datasets.ImageFolder(root='/Users/jay/datasets/Brain_Tumor_2/test', transform=transform)
