...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        # transformer
        self.transformer_layer = TransformerEncoderLayer(d_model=features[len(layers) - 1], nhead=8)
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        x = F.log_softmax(self.fc(x[:, -1, :]),
                          dim=1)  # Use only the last output of transformer as input for the FC layer
